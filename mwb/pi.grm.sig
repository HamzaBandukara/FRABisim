...
type ('a,'b) token
type svalue
val FWTRANS: (string) *  'a * 'a -> (svalue,'a) token
val FWEQ: (string) *  'a * 'a -> (svalue,'a) token
val FTRANS: (string) *  'a * 'a -> (svalue,'a) token
val FEQ: (string) *  'a * 'a -> (svalue,'a) token
val FAGENT: (string) *  'a * 'a -> (svalue,'a) token
val MAX: (string) *  'a * 'a -> (svalue,'a) token
val MIN: (string) *  'a * 'a -> (svalue,'a) token
...
val SOME2: (string) *  'a * 'a -> (svalue,'a) token
