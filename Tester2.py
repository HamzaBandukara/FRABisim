...
def record(path, file, representation, q1, s, q2, repetitions=3):
    ...
    dirs = ["fwd_m", "fwd_e", "fwd_g", "fwd_m2", "fwd_g2"]
    methods = [fwd_m, fwd_e, fwd_g, fwd_m2, fwd_g2]
    results = {}
...
def benchmarks(size=30, repetitions=1, start=1, steps=1):
    ...
    output_file.write(
        "TestCode,RA,States,Transitions,Memo,Exception,Generator,Memo2,Gen2,Result,DEQ-Result,DEQ-Time\n")
    ...
    for i in range(start, size, steps):
        ...
        q1 = representation.split("{")[2][:-1]
        record("Test_01_B", "LR_DS_{}".format(i), representation, q1, set(), q1, repetitions)
        output_file = open("Benchmarks_2.csv", "a")
        result, time = deq(representation, representation, repetitions)
        output_file.write(",{},{:.16f}\n".format(result, float(time)))
        output_file.close()
    ...
    for i in range(start, size, steps):
        ...
        q1 = representation.split("{")[2][:-1]
        record("Test_01_C", "RL_DS_{}".format(i), representation, q1, set(), q1, repetitions)
        output_file = open("Benchmarks_2.csv", "a")
        result, time = deq(representation, representation, repetitions)
        output_file.write(",{},{:.16f}\n".format(result, float(time)))
        output_file.close()
    ...
    for i in range(start, size, steps):
        ...
        q1 = representation.split("{")[2][:-1]
        record("Test_01_D", "LR_NDS_{}".format(i), representation, q1, set(), q1, repetitions)
        output_file = open("Benchmarks_2.csv", "a")
    ...
    for i in range(start, size, steps):
        ...
        q1 = representation.split("{")[2][:-1]
        record("Test_01_E", "RL_NDS_{}".format(i), representation, q1, set(), q1, repetitions)
        output_file = open("Benchmarks_2.csv", "a")
        output_file.write(",NA,NA\n")
        output_file.close()
    ...
    for i in range(start, size, steps):
        ...
        q1 = representation.split("{")[2][:-1]
        record("Test_01_F", "CPT_{}".format(i), representation, q1, set(), q1, repetitions)
    ...
    for i in range(start, size, steps):
        ...
        q1 = representation.split("{")[2][:-1]
        record("Test_01_F", "FLW_{}".format(i), representation, q1, set(), q1, repetitions)
...
if __name__ == '__main__':
    ...
    benchmarks(size=101, repetitions=1, start=20, steps=20)
