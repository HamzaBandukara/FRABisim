...
def record(path, file, representation, q1, s, q2, repetitions=3):
    ...
    with open("Benchmarks_3.csv", "a") as f:
...
def benchmarks(size=30, repetitions=1, start=1, steps=1):
    if not os.path.exists("./Benchmarks_3"):
        os.mkdir("./Benchmarks_3")
    output_file = open("Benchmarks_3.csv", "w")
    output_file.write(
        "TestCode,RA,States,Transitions,Base\n")
    ...
    #     output_file = open("Benchmarks_3.csv", "a")
