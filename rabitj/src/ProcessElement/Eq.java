...
public class Eq extends RawProcess {
    public int n1;
    public int n2;

    public Eq(String n1, String n2, Map<String, Integer> nmap){
        super();
        children = 1;
        this.n1 = nmap.get(n1);
        this.n2 = nmap.get(n2);
    ...
    public Eq(int n1, int n2, RawProcess child){
        super();
        children = 1;
        this.n1 = n1;
        this.n2 = n2;
    ...
    public RawProcess rewrite(int key, int new1) {
        ...
        if(n2 == key)
            second = new1;
        return new Eq(first, second, childProcess[0].rewrite(key, new1));
    }
    ...
    public RawProcess ReFix(Map<Integer, Integer> nameMap) {
        ...
        return new Eq(first, second, childProcess[0].ReFix(nameMap));
    }
